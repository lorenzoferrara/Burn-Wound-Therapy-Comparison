...
Even though this model has been reached after a feature selection phase, not all the variables are significant, in terms of p-value:

- the buttock variable and the treatment variable have respectively $p-value=0.047$ and $p-value=0.02$
- the burn.type variable has its electrical level very significant, with a p-value of 0.018
- the gender, with a p-value of 0.087, is the only one which cannot be considered significant at level 5% 

Nonetheless the model fit is on the whole good, with a global p-value of 0.0033 and the best performance with regard to the Likelihood and the complexity.
...
We also highlighted the importance of electricity among the causes of accidental burns.
